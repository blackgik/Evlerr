...
module.exports = function () {
    router.post("/auth/create-user", (0, validateResource_1.default)(user_ValidationSchema_1.userSchema), userController_1.default.createUserHandler);
    router.post("/auth/createSession", (0, validateResource_1.default)(user_ValidationSchema_1.sessionSchema), sessionController_1.default.createSessionHandler);
